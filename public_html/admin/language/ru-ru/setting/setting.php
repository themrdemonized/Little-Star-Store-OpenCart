...
$_['entry_schema_address']			   = 'Адрес для микроразметки';
...
$_['entry_logo_footer']                = 'Логотип в футере';
$_['entry_icon']                       = 'Иконка';
...
$_['entry_seo_url_short_category_path'] 	   = 'Короткие ЧПУ категорий';
...
$_['entry_config_seo_url_short_category_path'] 	   = 'Короткие ЧПУ категорий';
...
$_['help_schema_address']              = 'Запишите адрес для микроразметки в формате Страна;Регион;Город;Адрес;Почтовый индекс. ПОРЯДОК ОБЯЗАТЕЛЕН!';
...
$_['help_no_watermark']				   = 'Работает независимо от статуса ватермарка';
...
//Watermark
$_['text_config_watermark_status']               = 'Статус';
$_['text_config_watermark_hide_real_path']       = 'Скрывать путь к изображению в папке image';
$_['text_config_watermark_resize_first']         = 'Подогнать ватермарк к размеру изображения';
$_['text_config_watermark_image']                = 'Ватермарк';
$_['text_config_watermark_extension']                 = 'Конечное расширение изображения';
$_['text_config_watermark_zoom']                 = 'Увеличить/уменьшить';
$_['text_config_watermark_pos_x']                = 'Горизонтальная позиция<br/><i>(используйте отрицательное число для другой ориентации)</i>';
$_['text_config_watermark_pos_x_center']         = 'Горизонтально по центру';
$_['text_config_watermark_pos_y']                = 'Вертикальная позиция<br/><i>(используйте отрицательное число для другой ориентации)</i>';
$_['text_config_watermark_pos_y_center']         = 'Вертикально по центру';
$_['text_config_watermark_opacity']              = 'Прозрачность';
$_['text_config_watermark_category_image']       = 'Использовать для изображений категории';
$_['text_config_watermark_product_thumb']        = 'Использовать для изображений товара';
$_['text_config_watermark_product_popup']        = 'Использовать для всплывающих изображений';
$_['text_config_watermark_product_list']         = 'Использовать в списке товаров?';
$_['text_config_watermark_product_additional']   = 'Использовать в дополнительных изображениях';
$_['text_config_watermark_product_related']      = 'Использовать в связанных товарах';
$_['text_config_watermark_product_in_compare']   = 'Использовать в списке сравнения';
$_['text_config_watermark_product_in_wish_list'] = 'Использовать в списке желаний';
$_['text_config_watermark_product_in_cart']      = 'Использовать в корзине';

//Contacts
$_['tab_contacts'] = 'Контакты';
$_['tab_contacts_all'] = 'Для всех';
$_['contacts_addresses'] = 'Адреса';
$_['entry_contacts_data_email'] = 'E-Mail';
$_['entry_contacts_data_workhours'] = 'Часы работы';
$_['entry_contacts_data_name'] = 'Название';
$_['entry_contacts_data_address'] = 'Адреса';
$_['entry_contacts_data_address_tooltip'] = 'Несколько адресов указываются с новой строки';
$_['entry_contacts_data_phone'] = 'Телефоны';
$_['entry_contacts_data_phone_tooltip'] = 'Несколько телефонов указываются с новой строки';
$_['entry_contacts_data_coords'] = 'Координаты на карте';
$_['entry_contacts_data_coords_tooltip'] = 'Указываются в формате широта,долгота (например: 48.417226,135.10322)';