...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		if (!isset($this->request->get['user_token']) || !isset($this->session->data['user_token']) || ($this->request->get['user_token'] != $this->session->data['user_token'])) {
			...
			$data['mod_refresh'] = $this->url->link('marketplace/modification/refresh', 'user_token=' . $this->session->data['user_token'], true);
			$data['trade_import'] = $this->url->link('extension/module/trade_import', 'user_token=' . $this->session->data['user_token'], true);
