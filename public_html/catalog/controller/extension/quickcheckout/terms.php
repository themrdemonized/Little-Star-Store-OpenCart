  	...
  	public function index() {
		...
		if ($this->config->get('config_checkout_id')) {
			...
			if ($information_info) {
				...
				$data['agreement_title'] = $information_info['title'];
				$data['agreement'] = $this->url->link('information/information/agree', 'information_id=' . $this->config->get('config_checkout_id'), true);
			} else {
				$data['text_agree'] = '';
			}
		} else {
