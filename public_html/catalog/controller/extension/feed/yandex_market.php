...
//				$data['barcode'] = $product['sku'];
				...
				if (!empty($product['image'])) {
					$data['picture'] = $this->url->link('product/product_image', 'filename=' . $product['image'] . '&width=' . $bus_image_width . '&height=' . $bus_image_height);
					//$data['picture'] = $this->model_tool_image->get_image($product['image']);
				}

				if (isset($product['images'])) {
					foreach (explode(',', $product['images']) as $image) {
						$data['picture'] .= ',' . $this->url->link('product/product_image', 'filename=' . $image . '&width=' . $bus_image_width . '&height=' . $bus_image_height);
						//$data['picture'] .= ',' . $this->model_tool_image->get_image($image);
					}
				}
/*
