...
class ControllerAccountOrder extends Controller {
	public function index() {
		...
		foreach ($results as $result) {
			...
			$date = getdate(strtotime($result['date_added']));

			$data['orders'][] = array(
				'order_id'   => $result['order_id'],
				'name'       => $result['firstname'] . ' ' . $result['lastname'],
				'status'     => $result['status'],
				'date_added' => sprintf('%d %s %d', $date['mday'], $months[$date['mon']], $date['year']),
	...
	public function info() {
		...
		if ($order_info) {
			...
			$date = getdate(strtotime($order_info['date_added']));
			$data['date_added'] = sprintf('%d %s %d', $date['mday'], $months[$date['mon']], $date['year']);
