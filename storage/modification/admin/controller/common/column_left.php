		  ...
		  // OCFilter end
			...
			if ($this->user->hasPermission('access', 'catalog/city')) {
				$catalog[] = array(
					...
					'href'     => $this->url->link('catalog/city', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}

			if ($this->user->hasPermission('access', 'catalog/stocks')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_stocks'),
